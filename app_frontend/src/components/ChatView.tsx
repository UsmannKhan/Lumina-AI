...
//               {isStudyDropdownOpen && (
//                 <div className="absolute top-full mt-2 right-0 w-40 rounded-lg bg-void-900 border border-white/[0.08] shadow-xl z-[100] overflow-hidden">
//                   <button
//                     onClick={() => {
...
//                       activeTab === 'flashcards'
//                         ? 'bg-ember-500/20 text-ember-300'
//                         : 'text-void-300 hover:bg-white/[0.05] hover:text-void-100'
//                     )}
//                   >
//                     Flashcards
//                   </button>
